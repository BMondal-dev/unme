...
const MarqueeText = component$<{ text: string; isOnline: boolean }>(({ text, isOnline }) => {
  ...
  return (
    <div class="relative w-full overflow-hidden">
      <div ref={containerRef} class="relative w-full overflow-hidden">
        <div 
          ref={textRef} 
          class="inline-block whitespace-nowrap px-1 text-xs text-gray-600"
  ...
  ({ user, onBack$, onCall$, onVideoCall$, onViewProfile$ }) => {
    return (
      ...
      <div class="flex min-w-0 flex-1 items-center">
        <button
          onClick$={onBack$}
          class="mr-2 flex-shrink-0 rounded-lg border-2 border-black p-2 transition-colors hover:bg-fresh-eggplant-50 active:translate-y-0.5 sm:mr-3"
      ...
      <div class="flex items-center space-x-1 sm:space-x-2">
        <button
          onClick$={onVideoCall$}
          class="rounded-lg border-2 border-black p-1.5 transition-colors hover:bg-fresh-eggplant-50 active:translate-y-0.5 sm:p-2"
